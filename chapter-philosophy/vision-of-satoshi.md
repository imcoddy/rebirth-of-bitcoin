...
那些在比特币的设计之外探索的人尝试创造与比特币相伴的替代品，比如闪电网络。此种系统纯粹是为了丢失和销毁记录而设计的。资金的匿名形式将成为被法律取缔的最直接原因。如果一个系统违反了洗钱规则，则政府可以对运行节点的主体采取行动。像闪电网络之类的系统，其节点并不能任意加入和离开网络。这与比特币完全不同，闪电节点需要全天候与网络保持连接，这些节点也成为了执法人员的天然靶子。
